    ...
    <div class="global-wrap">
                        ...
                        <div class="col-md-4">
                            <div class="top-user-area clearfix">
                                <ul class="top-user-area-list list list-horizontal list-border">
                                    ...
                                    <li><a href="login-register-normal.jsp">Sign Out</a>
                                    </li>
                                    <li class="nav-drop"><a href="#">USD $<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i></a>
                                        <ul class="list nav-drop-menu">
                                            ...
                                            <li><a href="#">GBP<span class="right">Â£</span></a>
                                            </li>
                                            <li><a href="#">JPY<span class="right">å</span></a>
                                            </li>
        ...
        <div class="top-area show-onload">
            <div class="bg-holder full">
                ...
                <div class="bg-parallax" style="background-image:url(img/2048x1365.png);"></div>
        ...
        <div class="bg-holder">
            <div class="bg-mask"></div>
            <div class="bg-parallax" style="background-image:url(img/background_index.jpeg);"></div>
            <div class="bg-content">
                <div class="container">
